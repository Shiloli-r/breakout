...
function love.load()
    ...
    -- load up the graphics will be used throughout the states
    gTextures = {
    ...
    -- set up the sound effects; later, just index this table and
    ...
    -- in our game instead of clumping them together in the update and draw
    -- methods
    --
    -- The game state can be any of the following:
    ...
    -- a table used to keep track of which keys have been pressed this
