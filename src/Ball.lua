...
function Ball:init(skin)
    ...
    -- variables for keeping track of velocity on both X and Y axes
    self.dy = 0
    self.dx = 0

    -- this will effectively be the color of the ball, and we will index
    -- the table of Quads relating to the global block texture using this
    self.skin = skin    
end
