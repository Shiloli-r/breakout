--[[
    Represents the state the game is in when it's just started; should
...
function StartState:update(dt)
    ...
    -- confirm whichever option is selected to change screens
    ...
    -- this is no longer available globally, so include here
...
function StartState:render()
    ...
    -- if highlighting 1, render that option in blue
    if highlighted == 1 then
    ...
    -- render option 2 blue if it's being highlighted
